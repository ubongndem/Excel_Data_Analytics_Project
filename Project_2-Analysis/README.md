...
Driven by a passion for data and my own job search, I put together this Excel project to make sense of the data science job market. I gathered real job posting data and analyzed salaries, roles, locations, and required tech stacks. Through Excel; using Power Query, DAX, and interactive charts.

I found that mastering Python, SQL, and cloud tools directly aligns with top tier pay. This repository serves as a practical guide for anyone aiming for higher-paying data roles.
